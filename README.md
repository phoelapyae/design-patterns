...
- Undo/Redo: Command တွေကို Object အနေနဲ့ သိမ်းထားတဲ့အတွက် History အနေနဲ့ သိမ်းထားပြီး မူလအတိုင်း ပြန်ပြင်တာ (Undo) မျိုးတွေ အလွယ်တကူ လုပ်နိုင်ပါတယ်။
...
ဒီကောင်က လုပ်သမျှ Command တွေကို Array (Stack) ထဲမှာ History အဖြစ် သိမ်းထားပေးမှာ ဖြစ်ပါတယ်။
...
- $editor->history ထဲမှာ ["Hello " ရိုက်ခဲ့တဲ့ Object], ["World!" ရိုက်ခဲ့တဲ့ Object] ဆိုပြီး History ရှိနေလို့ပါ။
